                        ...
                        <form action="{{ route('email.update', $email->id) }}" method="POST">
                            ...
                            <div class="row p-2">
                                <div class="form-floating mb-3 c col-md-6">
                                    <input name="subject" value="{{ old('subject' , $email->subject) }}" type="text" onkeyup="counterTitle(this)" required
                                ...
                                <section class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="published_at" value="{{ $email->published_at }}" id="published_at"
                                            class="form-control form-control-sm d-none ">
                                        <input type="text" id="published_at_view" value="{{ $email->published_at }}" class="form-control form-control-sm">
                                    </div>
                                    @error('published_at')
