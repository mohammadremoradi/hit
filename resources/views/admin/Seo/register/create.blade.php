...
@section('title')
    <title>Create SEO FOR register form Page</title>
@endsection
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Create SEO FOR register form PAGE</li>
                    </ol>
                </div>
            </div>
    </section>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('register-page.store') }}" method="POST">
                            @csrf
                            <div class="row p-2">
                                @if ($errors->any())
