...
@section('title')
    <title>Edit SEO FOR why hit PAGE</title>
@endsection
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('whyus-page.index') }}">SEO FOR why hit PAGE</a></li>
                        <li class="breadcrumb-item active">Edit SEO FOR why hit PAGE</li>
                    </ol>
                </div>
            </div>
    </section>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('whyus-page.update', $whyus_page->id) }}" method="POST">
                            @method('put')
                            @csrf
                            <div class="row p-2">
                                @if ($errors->any())
                                ...
                                <div class="form-floating mb-3 c col-md-4">
                                    <input name="name" value="{{ old('name', $whyus_page->name) }}" type="text"
                                ...
                                <div class="form-floating mb-5 col-md-4">
                                    <select dir="rtl" class="form-select" name="lang" id="floatingSelect"
                                        ...
                                        @foreach ($langs as $lang)
                                            <option @selected($lang === $whyus_page->lang) value="{{ $lang }}">
                                                {{ $lang }}
                                            </option>
                                        @endforeach
                                ...
                                <div class="form-floating mb-5 col-md-4">
                                    <select dir="rtl" class="form-select" name="location" id="floatingSelect"
                                        aria-label="Floating label select example">
                                        <option @selected(old('location', $whyus_page->location) == 'header') value="header">
                                            header
                                        </option>
                                        <option @selected(old('location', $whyus_page->location) == 'script') value="script">
                                            script
                                        </option>
                                    </select>
                            ...
                            <div class="form-floating col-md-6">
                                <textarea name="script" class="form-control" placeholder="Leave a comment here" id="floatingTextarea2"
                                    style="height: 100px">{{ old('script', $whyus_page->script) }}</textarea>
