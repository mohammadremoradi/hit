...
@section('title')
    <title>Create Countact US Page</title>
@endsection
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Create Seo Countact US Page</li>
                    </ol>
                </div>
            </div>
    </section>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('contact-us-page.store') }}" method="POST" >
                            @csrf
                            <div class="row p-2">
                                @if ($errors->any())
                                ...
                                <div class="form-floating mb-3 c col-md-6">
                                    <textarea style="height: 150px"  name="script" type="text" required
                                        class="form-control" id="floatingInput" placeholder="script">{{ old('script') }}</textarea>
