            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Edit Course Page</li>
                    </ol>
                </div>
            </div>
    </section>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('course-page.update', $course_page->id) }}" method="POST"
                            ...
                            <div class="row p-2">
                                ...
                                <div class="form-floating mb-3 c col-md-4">
                                    <input name="name" value="{{ old('name', $course_page->name) }}" type="text"
                                ...
                                <div class="form-floating mb-5 col-md-4">
                                    <select dir="rtl" class="form-select" name="lang" id="floatingSelect"
                                        ...
                                        @foreach ($langs as $lang)
                                            <option @selected($lang === $course_page->lang) value="{{ $lang }}">
                                                {{ $lang }}
                                            </option>
                                        @endforeach
                                ...
                                <div class="form-floating mb-5 col-md-4">
                                    <select dir="rtl" class="form-select" name="location" id="floatingSelect"
                                        aria-label="Floating label select example">
                                            <option @selected(old('location', $course_page->location) == "header") value="header">
                                                header
                                            </option>
                                            <option @selected(old('location', $course_page->location) == "script") value="script">
                                                script
                                            </option>
                                    </select>
                                    <label for="floatingSelect">Language</label>
                            ...
                            <div class="form-floating col-md-6">
                                <textarea name="script" class="form-control" placeholder="Leave a comment here" id="floatingTextarea2"
                                    style="height: 100px">{{ old('script', $course_page->script) }}</textarea>
