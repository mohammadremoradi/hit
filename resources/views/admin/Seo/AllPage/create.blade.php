...
@section('title')
    <title>Create seo All Page</title>
@endsection
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Create Seo All Page</li>
                    </ol>
                </div>
            </div>
    </section>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('seo-all-pages.store') }}" method="POST">
                            @csrf
                            <div class="row p-2">
                                @if ($errors->any())
                                ...
                                <div class="form-floating mb-5 col-md-4">
                                    <select class="form-select" name="lang" id="floatingSelect"
                                        ...
                                        @endforeach
                                        <option @selected(old('lang') == 'both') value="both">Both </option>
                                    </select>
