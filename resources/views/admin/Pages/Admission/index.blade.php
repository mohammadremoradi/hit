                        ...
                        <div class="card-header">
                            ...
                            <div class="float-right mb-5">
                                ...
                                @if (count($informations) < 2)
                                    <a class="btn btn-success" href="{{ route('admission.create') }}"> Create </a>
                                @endif
                                    ...
                                    @foreach ($informations as $information)
                                        <tr>
                                            ...
                                            <td style="text-align:center;" class="d-flex">
                                                {{-- <a href="{{ route('course.show', $information->id) }}"
                                                    class="btn btn-sm btn-outline-success px-3 my-0 mx-1">
                                                    <i class="far fa-check-square"></i>
                                                </a> --}}
                                                <a href="{{ route('admission.edit', $information->id) }}"
                                                    class="btn btn-sm btn-outline-warning px-3 my-0 mx-1"><i
                                                        class="fas fa-edit"></i>
                                                </a>

                                                <form class="d-inline"
                                                    action="{{ route('admission.destroy', $information->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('Delete')
